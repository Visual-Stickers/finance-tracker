    ...
    <div>
      ...
      <div className="chart-card card">
        ...
        {loans.length ? loans.map((l) => <LoanProgressRow key={l._id} l={l} />) : (
          <div className="empty"><p>No loans added yet. <a href="/loans" className="text-blue">Add a loan →</a></p></div>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div className="card mb-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <a href="/income-expense" className="text-xs text-blue font-semibold">View details →</a>
      </div>
