// Master seed data used only the very first time a new user signs in and has
// no rows yet. Feel free to edit or empty this out — it's just a starting
// point ported from the original app so existing users see familiar data.
