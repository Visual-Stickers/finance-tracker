// Finance Command Center - Master Data
// Pre-seeded from Excel: Prem's Accounts
  ...
  loans: [
    {
      ...
      bank: "HDFC Bank",
      principal: 1346516,
      netDisbursed: 1322130,
      outstanding: 1319259.06,
      emi: 25184,
      interestRate: 10.35,
      apr: 10.42,
      totalInterest: 462834,
      totalPayable: 1809350,
      tenure: 72,
      emisPaid: 2,
      emisRemaining: 70,
      startDate: "2026-05-01",
      endDate: "2032-04-01",
      emiStartDate: "2026-06-05",
      emiEndDate: "2032-06-04",
      repaymentMode: "Auto Debit",
      processingFee: 7670,
      stampDuty: 200,
      insurance: 16516,
      bounceCharge: 450,
      preclosureCharge0to24M: 0.04,
      preclosureCharge24to36M: 0.03,
      preclosureCharge36Mplus: 0.02,
      partPaymentLimit: 0.25,
      partPaymentFrequency: "1 per year",
      maxPartPayments: 2,
      paymentHistory: []
    }
  ],
  creditCards: [],
  // 2026 monthly plan from sheet "2026"
  monthlyPlan: {
    months: [
