...
function openEmiModal(supabaseId) {
  ...
  document.getElementById('emi-save').dataset.loanId = supabaseId;
...
function confirmEmiPayment() {
  const supabaseId = document.getElementById('emi-save').dataset.loanId;
  if (supabaseId) saveEmiPayment(supabaseId);
}
