...
function openPayModal(cardId) {
  ...
  document.getElementById('pay-save').dataset.cardId = cardId;
...
let _activePayCardId = null;
function confirmPayment() {
  const cardId = document.getElementById('pay-save').dataset.cardId;
  if (cardId) savePayment(cardId);
}
